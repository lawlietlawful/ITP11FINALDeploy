        ...
        <aside class="sidebar w-[260px] flex-shrink-0 flex flex-col px-5 pt-6 lg:pt-8 pb-5 my-5 lg:my-7 ml-5 lg:ml-7 sticky top-5 lg:top-7 h-[calc(100vh-40px)] lg:h-[calc(100vh-56px)] rounded-3xl overflow-y-auto hidden md:flex">
            ...
            <div class="mb-8 px-2">
                <div class="flex items-center gap-3">
                    @php $systemLogo = \App\Models\Setting::where('key', 'system_logo')->value('value') ?: asset('New Logo.png'); @endphp
                    <img src="{{ $systemLogo }}" alt="VistáBarangay Logo" class="w-10 h-10 flex-shrink-0 rounded-full object-cover shadow-md ring-2 ring-primary-100">
                    <div>
            ...
            <nav class="flex-1 space-y-1">
                @php
                    ...
                    if (auth()->user()->role === 'admin') {
                        $links[] = ['route' => 'settings.index', 'label' => 'Settings', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>'];
                    }
                @endphp
